...
public class Asteroide
{
    ...
    public void Update(Processing sketch)
    {
        ...
        if (Position.X > sketch.width + Size + 51) Position.X = -Size - 50;
        if (Position.X < -Size - 51) Position.X = sketch.width + Size + 50;
        if (Position.Y > sketch.height + Size + 51) Position.Y = -Size - 50;
        if (Position.Y < -Size - 51) Position.Y = sketch.height + Size + 50;
